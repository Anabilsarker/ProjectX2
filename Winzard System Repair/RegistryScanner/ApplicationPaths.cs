...
namespace Winzard_System_Repair.RegistryScanner
{
    public class ApplicationPaths : ScannerBase
    {
        ...
        private static void ScanInstallFolders()
        {
            ...
            {
                ScannerFunctions.CurrentScannedObject = strFolder;

                if (!Utils.DirExists(strFolder))
                    ScannerFunctions.StoreInvalidKey(Strings.InvalidFile, regKey.Name, strFolder);
            }
        }
        ...
        private static void ScanAppPaths()
        {
            ...
            foreach (string strSubKey in regKey.GetSubKeyNames())
            {
                ...
                if (regKey2 != null)
                {
                    ...
                    ScannerFunctions.StoreInvalidKey(Strings.InvalidFile, regKey2.Name);
                }
            }
